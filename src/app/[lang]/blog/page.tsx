...
export default async function page() {
  ...
  return (
    <div className="flex flex-col justify-center items-center gap-10 w-full">
      ...
      <section className="grid md:grid-cols-1 grid-cols-1 md:gap-4 gap-12 w-full max-w-[800px] mx-auto border-r border-l border-gray-300/30 px-5">
        <h2 className="font-bold text-4xl border-b-[7px] pb-4 text-white border-[#f47521]">
          Hottest Hentai
        </h2>
